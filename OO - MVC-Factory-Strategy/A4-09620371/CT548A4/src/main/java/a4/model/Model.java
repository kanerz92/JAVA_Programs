...
public class Model {
	 ...
	 // TreeSet keeps sorted and no duplicates already sorted. Inventory or items which have common elements TV/Film
	 // Decouple all components into all the classes. TreeSets so no duplicate Genres/People/Years need stored.
