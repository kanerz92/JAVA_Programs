...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 // Creating container and Context object which takes in a Strategy in its constructor.
		 // SortedYear implements Strategy, so creating new Object and passing in constructor.
